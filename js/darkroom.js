    ...
    ButtonGroup.prototype = {
        createButton: function(options) {
            ...
            if (options.tooltip.length > 0) {
                ...
                buttonElement.dataset['placement'] = 'top';
            }
