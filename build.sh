...
pyinstaller --onefile --windowed -p "/usr/lib/python3.5/site-packages/PyQt5/" --icon=img/app-icon.png --workpath=_build/work --distpath=_build/final ./ocrtranslator.spec
